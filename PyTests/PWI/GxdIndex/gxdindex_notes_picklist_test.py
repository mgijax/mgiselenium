...
class TestEiGxdIndexNotesPicklist(unittest.TestCase):
    ...
    def testAgeNotSpecified(self):
        ...
        self.assertEqual(agenote, "Age of embryo at noon of plug day not specified in reference.",
    ...
    def testAgeAssigned(self):
        ...
        agenote = form.get_value('note')  # Get what text is in the notes field
        self.assertEqual(agenote, "Age assigned by curator based on morphological criteria supplied by authors.",
                         "The note is incorrect")
