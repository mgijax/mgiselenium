...
class TestPwiAlleleDetail(unittest.TestCase):
    ...
    def test_disease_annotations(self):
        ...
        element = driver.find_elements(By.XPATH, '/html/body/main/div/div/div[2]/div/div[4]/dl[2]')
    ...
    def test_AlleleDet_all_lvls_pheno(self):
        ...
        accbox.send_keys(Keys.RETURN)
        WebDriverWait(driver, 25).until(EC.presence_of_element_located((By.CSS_SELECTOR, 'div.genotypeDetail:nth-child(1085) > dl:nth-child(1) > dd:nth-child(6)')))#waits until the last phenotype annotation MGI ID is displayed on the page
        ...
        pheno_id10 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(102) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id11 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(103) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id12 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(104) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id13 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(105) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id14 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(106) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id15 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(109) > dl:nth-child(1) > dd:nth-child(6)")
        ...
        pheno_id19 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(115) > dl:nth-child(1) > dd:nth-child(6)")
        ...
        pheno_id22 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(119) > dl:nth-child(1) > dd:nth-child(6)")
        ...
        self.assertIn(pheno_id22.text, "MGI:5308956 (key 59703)")
