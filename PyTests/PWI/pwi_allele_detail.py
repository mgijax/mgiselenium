...
class TestPwiAlleleDetail(unittest.TestCase):
    ...
    def test_disease_annotations(self):
        ...
        @note rewritten on 4/8/2022 (this test is not working but I can't figure out why! 6/6/2023
        """
        driver = self.driver
        #opens the PWI
        ...
        #term1 = driver.find_elements(By.CSS_SELECTOR,'dl.detailPageListData:nth-child(12) > dd:nth-child(2)')
        element = driver.find_elements(By.XPATH, '/html/body/main/div/div/div[2]/div/div[4]/dl[3]')
    ...
    def test_AlleleDet_all_lvls_pheno(self):
        ...
        accbox.send_keys(Keys.RETURN)
        WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.CSS_SELECTOR, 'div.genotypeDetail:nth-child(272) > div:nth-child(3) > div:nth-child(2) > span:nth-child(1) > a:nth-child(1)')))#waits until the phenotype annotations for MGI:6241534 is displayed on the page
        #find the high level phenotype terms for the forth genotype(MGI:3852467 (key 46893))
        high_lvl_term1 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(81) > div:nth-child(3) > span:nth-child(1)")
        high_lvl_term2 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(81) > div:nth-child(4) > span:nth-child(1)")
        high_lvl_term3 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(81) > div:nth-child(5) > span:nth-child(1)")
        print(high_lvl_term1.text)
        print(high_lvl_term2.text)
        print(high_lvl_term3.text)  
        #asserts that the terms are correct and in the correct order
        ...
        pheno_id3 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(81) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id4 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(86) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id5 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(87) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id6 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(91) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id7 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(99) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id8 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(101) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id9 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(102) > dl:nth-child(1) > dd:nth-child(6)")
        ...
        pheno_id13 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(111) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id14 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(112) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id15 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(113) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id16 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(114) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id17 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(116) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id18 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(117) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id19 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(118) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id20 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(119) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id21 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(120) > dl:nth-child(1) > dd:nth-child(6)")
        pheno_id22 = driver.find_element(By.CSS_SELECTOR, "div.genotypeDetail:nth-child(124) > dl:nth-child(1) > dd:nth-child(6)")
        ...
        self.assertIn(pheno_id3.text, "MGI:3852467 (key 46893)")
        self.assertIn(pheno_id4.text, "MGI:5702903 (key 75711)")
        self.assertIn(pheno_id5.text, "MGI:4839957 (key 53677)")
        self.assertIn(pheno_id6.text, "MGI:3531461 (key 20218)")
        self.assertIn(pheno_id7.text, "MGI:3807487 (key 40126)")
        self.assertIn(pheno_id8.text, "MGI:5563247 (key 69742)")
        self.assertIn(pheno_id9.text, "MGI:3836424 (key 43990)")
        self.assertIn(pheno_id10.text, "MGI:3767612 (key 35568)")
        self.assertIn(pheno_id11.text, "MGI:3767613 (key 35569)")
        self.assertIn(pheno_id12.text, "MGI:4940095 (key 54878)")
        self.assertIn(pheno_id13.text, "MGI:5563246 (key 69741)")
        self.assertIn(pheno_id14.text, "MGI:5447167 (key 63213)")
        self.assertIn(pheno_id15.text, "MGI:5447168 (key 63214)")
        self.assertIn(pheno_id16.text, "MGI:5304570 (key 59128)")
        self.assertIn(pheno_id17.text, "MGI:5285375 (key 57539)")
        self.assertIn(pheno_id18.text, "MGI:5308956 (key 59703)")
        self.assertIn(pheno_id19.text, "MGI:5308958 (key 59704)")
        self.assertIn(pheno_id20.text, "MGI:4822000 (key 52423)")
        self.assertIn(pheno_id21.text, "MGI:5911951 (key 84592)")
        self.assertIn(pheno_id22.text, "MGI:4353176 (key 46983)")
