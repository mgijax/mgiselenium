...
class TestEiEmapaTreeView(unittest.TestCase):
    ...
    def testBasicSort(self):
        ...
        self.assertEqual(searchTreeItems,
                         ["mouse", "body fluid or substance", "body region", "cavity or lining", "conceptus",
                          ...
                          "organ", "organ system", "tissue", "umbilical or vitelline vessel"])
    ...
    def testDetailParent(self):
        ...
        self.assertEqual(items[4].text.split("\n"),
                         ["is-a renal tubule", "part-of developing capillary loop stage nephron group",
                          "part-of early nephron", "part-of late tubule", "part-of mature nephron",
                          "part-of maturing nephron", "part-of renal cortex", "part-of stage IV immature nephron"])
        ...
        self.assertEqual(items[4].text.split("\n"),
                         ["is-a renal tubule", "part-of developing capillary loop stage nephron group",
                          "part-of early nephron", "part-of late tubule", "part-of maturing nephron",
        ...
        self.assertEqual(items[4].text.split("\n"),
                         ["is-a renal tubule", "part-of developing capillary loop stage nephron group",
                          "part-of early nephron", "part-of late tubule", "part-of maturing nephron",
                          "part-of renal cortex", "part-of stage IV immature nephron"])
