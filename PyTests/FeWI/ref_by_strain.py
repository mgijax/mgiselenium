...
class TestRefByStrain(unittest.TestCase):
    ...
    def test_ref_by_strain_sort(self):
        ...
        print(row7.text)
        self.assertEqual(row1.text, '2026')
        self.assertEqual(row2a.text, '41203011\nJ:377138\nJournal Link')
        self.assertEqual(row3a.text, '41326786\nJ:377332\nJournal Link')
        self.assertEqual(row4a.text, '39362025\nJ:359215\nJournal Link')
        self.assertEqual(row2.text, '2026')
        self.assertEqual(row3.text, '2026')
