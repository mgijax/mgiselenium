...
from FeWI import do_browser_general, do_browser_term, do_browser_gene, do_browser_model
...
#Put them in an Array
    do_browser_tests = unittest.TestSuite([do_browser_general_test, do_browser_term_tab_test, do_browser_gene_tab_test, do_browser_model_tab_test])
#file
    dir = os.getcwd()
