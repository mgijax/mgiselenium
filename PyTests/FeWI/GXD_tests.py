...
from FeWI import gxd_diff_qf, gxd_image_summary, gxd_qf, gxd_rna_seq_qf_autocomplete_list, gxd_rna_seq_qf_search, gxd_rna_seq_summary, gxd_txp_matrix, gxd_txs_matrix
...
#Put them in an Array
    gxd_tests = unittest.TestSuite([gxd_diff_qf_test, gxd_image_summary_test, gxd_qf_test, gxd_rna_seq_qf_autocomplete_test, gxd_rna_seq_qf_search_test, gxd_rna_seq_summary_test, gxd_txp_matrix_test, gxd_txs_matrix_test])
#file
    dir = os.getcwd()
