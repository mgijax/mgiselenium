...
class TestHmdcAutocomplete(unittest.TestCase):
    ...
    def test_index_tab_headers(self):
        ...
        self.assertEqual(items[4].text, "LibmannSachs, Endocarditis in systemic lupus erythematosus", "Term 4 is not visible!")
        ...
        self.assertEqual(items[7].text, "decreased susceptibility to systemic lupus erythematosus", "Term 7 is not visible!")
        self.assertEqual(items[8].text, "increased resistance to systemic lupus erythematosus", "Term 8 is not visible!")
        self.assertEqual(items[9].text, "reduced susceptibility to systemic lupus erythematosus", "Term 9 is not visible!")
