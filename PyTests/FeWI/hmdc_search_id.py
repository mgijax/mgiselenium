...
class TestHmdcSearchID(unittest.TestCase):
    ...
    def test_do_term_id(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "DOID:11949")  # enter primary DOID for Creutzfeldt-Jakob disease
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "11949")  # enter primary DOID for Creutzfeldt-Jakob disease
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_OMIM_term_id(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "OMIM:125852")  # enter OMIM ID for type 1 diabetes mellitus 2
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
        ...
        id = self.driver.find_element(By.ID, 'diseaseTable').find_element(By.CSS_SELECTOR,
                                                                          'span.ng-scope > a:nth-child(1)')
        print(id.text)
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "125852")  # enter an OMIM ID without the prefix (a disease ID)
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "OMIM:605230")  # enter an OMIM gene id -- this should return nothing using this query field
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_do_alt_ids(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "DOID:183")  # enter a DOID that is a secondary one for osteosarcoma
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
        ...
        # Verify disease searched for is returned
        # Get the list of diseases (by DOID)
        id1 = self.driver.find_element(By.ID, 'diseaseTable').find_element(By.CSS_SELECTOR,
                                                                           '#diseaseTable > tbody:nth-child(2) > tr:nth-child(1) > td:nth-child(2) > a:nth-child(1)')
        print(id1.text)
    ...
    def test_mp_term_id(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "MP:0005653")  # primary ID for phototoxicity
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
        ...
        id1 = self.driver.find_element(By.ID, 'diseaseTable').find_element(By.CSS_SELECTOR,
                                                                           '#diseaseTable > tbody:nth-child(2) > tr:nth-child(1) > td:nth-child(2) > a:nth-child(1)')
        print(id1.text)
        id2 = self.driver.find_element(By.ID, 'diseaseTable').find_element(By.CSS_SELECTOR,
                                                                           '#diseaseTable > tbody:nth-child(2) > tr:nth-child(2) > td:nth-child(2) > a:nth-child(1)')
        print(id2.text)
        id3 = self.driver.find_element(By.ID, 'diseaseTable').find_element(By.CSS_SELECTOR,
        ...
        # Grab the gene list and verify the mouse gene is returned but NOT the human ortholog
        id1 = self.driver.find_element(By.ID, 'geneTable').find_element(By.CSS_SELECTOR,
                                                                        '#geneTable > tbody:nth-child(2) > tr:nth-child(1) > td:nth-child(2) > nobr:nth-child(1) > a:nth-child(1) > div:nth-child(1)')
        print(id1.text)
        id2 = self.driver.find_element(By.ID, 'geneTable').find_element(By.CSS_SELECTOR,
                                                                        '#geneTable > tbody:nth-child(2) > tr:nth-child(2) > td:nth-child(2) > nobr:nth-child(1) > a:nth-child(1) > div:nth-child(1)')
        print(id2.text)
        id3 = self.driver.find_element(By.ID, 'geneTable').find_element(By.CSS_SELECTOR,
        ...
        phenocells[
            6].click()  # clicks the integument data cell to open up the genotype popup page (data changes can break this logic)
    ...
    def test_mp_term_altid(self):
        ...
        my_select = self.driver.find_element(By.XPATH,
                                             "//select[starts-with(@id, 'field_0_')]")  # identifies the select field and picks an option
        for option in my_select.find_elements(By.TAG_NAME, "option"):
            if option.text == 'Disease or Phenotype ID(s)':
                option.click()
                break
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Fyler:1431")  # enter Alt ID for MP:0010472 (abnormal ascending aorta and coronary artery attachment)
        wait.forAngular(self.driver)
    ...
    def test_hp_term_id(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "HP:0006285")  # identifies the input field and enters an HP ID
        wait.forAngular(self.driver)
        # find and click the Add button
        self.driver.find_element(By.CSS_SELECTOR, "button.ng-scope > span:nth-child(1)").click()
        # self.driver.find_element(By.XPATH, "//*[contains(text(), 'Add')]").click()
        ...
        if WebDriverWait(self.driver, 5).until(EC.presence_of_element_located((By.CSS_SELECTOR, '.tab-content'))):
            print('Grid Table loaded')
        # first cell captures all the table data blocks of phenotypes on the first row of data
        phenocells = self.driver.find_elements(By.CSS_SELECTOR,
        ...
        self.driver.switch_to.window(self.driver.window_handles[1])  # switches focus to the genotype popup page
        wait.forNewWindow(self.driver, 5)
        matching_text = "Human craniofacial abnormalities for DLX3/Dlx3"
        # asserts the heading text is correct in page source
        self.assertIn(matching_text, self.driver.page_source, 'expected pop-up box heading not displayed')
    ...
    def test_do_term_xref_id(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "KEGG:04950")  # XREF id for DOID:0050524 (maturity-onset diabetes of the young)
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_mp_term_multi_id(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "MP:0011006, MP:0005653, MP:0011905")  # identifies the input field and enters gata1
        wait.forAngular(self.driver)
        # find and click the Add button
        self.driver.find_element(By.CSS_SELECTOR, 'button.ng-scope > span:nth-child(1)').click()
        # self.driver.find_element(By.XPATH, "//*[contains(text(), 'Add')]").click()
    ...
    def test_hp_term_multi_id(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "HP:0008529, HP:0100739, HP:0012232")  # identifies the input field and enters gata1
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_mixed_term_multi_id(self):
        ...
        my_select = self.driver.find_element(By.XPATH,
                                             "//select[starts-with(@id, 'field_0_')]")  # identifies the select field and picks the disease or phenotypes IDs option
        for option in my_select.find_elements(By.TAG_NAME, "option"):
            if option.text == 'Disease or Phenotype ID(s)':
                option.click()
                break
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "HP:0006279, MP:0009182")  # identifies the input field and enters an HP and MP ID
        wait.forAngular(self.driver)
        # find and click the Add button
        self.driver.find_element(By.CSS_SELECTOR, "button.ng-scope > span:nth-child(1)").click()
        # self.driver.find_element(By.XPATH, "//*[contains(text(), 'Add')]").click()
        ...
        self.driver.find_element(By.CSS_SELECTOR,
                                 '.formly-field-queryRow > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > ng-form:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > input:nth-child(1)').send_keys("Pax4")
        ...
        self.driver.switch_to.window(self.driver.window_handles[1])  # switches focus to the genotype popup page
        if WebDriverWait(self.driver, 5).until(EC.presence_of_element_located((By.CLASS_NAME, 'popupTable'))):
            print('The Mouse Phenotype data is displayed')
        #wait.forNewWindow(self.driver, 5)
    ...
    def test_do_term_id_down_dag(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "DOID:2581")  # identifies the input field and enters term/ID
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
