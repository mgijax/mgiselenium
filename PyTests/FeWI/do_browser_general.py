...
class TestDoBrowserGeneral(unittest.TestCase):
    ...
    def test_dobrowser_header(self):
        ...
        print alt_id.text
        time.sleep(1)
        self.assertEqual(alt_id.text, "OMIM:168600, OMIM:300557, OMIM:556500, OMIM:602404, OMIM:606852, OMIM:613164, EFO:0002508, ICD10CM:G20, ICD9CM:332, ICD9CM:332.0, KEGG:05012, MESH:D010300, NCI:C26845, ORDO:2828, UMLS_CUI:C0030567")
