...
class TestDoBrowserGeneral(unittest.TestCase):
    ...
    def test_dobrowser_header(self):
        ...
        header = self.driver.find_element(By.ID,
        ...
        syn = self.driver.find_element(By.ID,
                                       'diseaseSynonym')  # identifies the synonym line in the header section of the DO Browser page
        print(syn.text)

        self.assertEqual(syn.text, "paralysis agitans; Parkinson disease")
        alt_id = self.driver.find_element(By.ID,
                                          'diseaseSecondaryIDs')  # identifies the alternate IDs line of the header section of the DO Browser page
        print(alt_id.text)

        self.assertIn(alt_id.text,
                      "OMIM:607688, OMIM:610297, OMIM:613643, OMIM:614251, EFO:0002508, ICD10CM:G20, ICD9CM:332, ICD9CM:332.0, KEGG:05012, MESH:D010300, NCI:C26845, OMIM:PS168600, ORDO:2828, UMLS_CUI:C0030567")

        # locates and verifies the definition
        definition = self.driver.find_element(By.ID,
                                              'diseaseDefinition')  # identifies the Definition line of the header section of the DO Browser page
        print(definition.text)

        self.assertEqual(definition.text,
    ...
    def test_dobrowser_altIDs_links(self):
        ...
        print(alt_id.text)
        self.assertIn(alt_id.text,
                      "ICD10CM:G20, ICD9CM:332, ICD9CM:332.0, KEGG:05012, MESH:D010300, NCI:C26845, OMIM:PS168600, ORDO:2828, UMLS_CUI:C0030567 ")
        ...
        # self.assertEqual(self.driver.current_url,
                         # 'https://www.ebi.ac.uk/ols/ontologies/efo/terms?short_form=EFO_0002508',
                         # 'The EFO link is broken!')
        # self.driver.close()
        # self.driver.switch_to.window(self.driver.window_handles[1])
        # if WebDriverWait(self.driver, 2).until(EC.presence_of_element_located((By.CLASS_NAME, 'titleBarMainTitle'))):
            # print('DO Browser page loaded')
        ...
        print(self.driver.current_url)
        self.assertEqual(self.driver.current_url, 'https://www.genome.jp/dbget-bin/www_bget?map05012',
                         'The KEGG link is broken!')
        self.driver.close()
        self.driver.switch_to.window(self.driver.window_handles[1])
        if WebDriverWait(self.driver, 2).until(EC.presence_of_element_located((By.CLASS_NAME, 'titleBarMainTitle'))):
            print('DO Browser page loaded')
        ...
        print(self.driver.current_url)
        self.assertEqual(self.driver.current_url, 'https://www.ncbi.nlm.nih.gov/mesh/D010300',
                         'The MESH link is broken!')
        self.driver.close()
        self.driver.switch_to.window(self.driver.window_handles[1])
        if WebDriverWait(self.driver, 2).until(EC.presence_of_element_located((By.CLASS_NAME, 'titleBarMainTitle'))):
            print('DO Browser page loaded')
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        if WebDriverWait(self.driver, 4).until(EC.presence_of_element_located((By.CLASS_NAME, 'fs-5'))):
            print('ordo page loaded')
        print(self.driver.current_url)
        self.assertEqual(self.driver.current_url, 'https://www.orpha.net/en/disease/detail/2828',
                         'The ORDO link is broken!')
