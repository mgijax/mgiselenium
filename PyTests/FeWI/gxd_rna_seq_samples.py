...
class TestGxdRnaSeqSamples(unittest.TestCase):
    ...
    def test_rnaseq_samples_expression_atlas_link(self):
        ...
        Select(self.driver.find_element(By.ID, 'theilerStage')).select_by_value(
            '27')  # finds the theiler stage list and select the TS 27 option
        self.driver.find_element(By.ID, 'strainNameAC').send_keys(
            'C57BL/6J')  # finds the strain field and enter C57BL/6J
        # find the Search button and click it
        self.driver.find_element(By.ID, 'submit1').click()
        # find the View button of the first result and click it
        self.driver.find_element(By.ID, 'row0button').click()
    ...
    def test_rnaseq_samples_geo_link(self):
        ...
        self.driver.find_element(By.ID, 'strainNameAC').send_keys(
            'C57BL/6J')  # finds the age list and select the E4.0 option
        # find the Search button and click it
        self.driver.find_element(By.ID, 'submit1').click()
        time.sleep(2)
    ...
    def test_rnaseq_samples_mutant_note(self):
        ...
        self.driver.find_element(By.ID, 'arrayExpressID').send_keys(
            'E-GEOD-37646')  # finds the age list and select the E4.0 option
        # find the Search button and click it
        self.driver.find_element(By.ID, 'submit1').click()
        time.sleep(2)
        # find the View button of the first result and click it
