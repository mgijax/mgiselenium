...
class TestHmdcGenesSearch(unittest.TestCase):
    ...
    def test_rel_broad_hp_standard(self):
        ...
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0025144")  #identifies the input field and enters an MP ID
    ...
    def test_rel_broad_hp_standard2(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0003560")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
        # Iterate the table columns for rows 1
    ...
    def test_rel_hp_add_man_match(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0002414")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
        ...
        self.assertEqual(termsyn2.text,'failure of neural tube closure | hydrocele spinalis | schistorrhachis | spina bifida')
    ...
    def test_rel_hp_add_lex_match(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0012535")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
        ...
        self.assertEqual(termsyn1.text, 'abnormal paired pulse depression | abnormal paired-pulse depression | abnormal paired pulse inhibition | abnormal PPD | abnormal PPI')
        # Verify table row 2
        ...
        self.assertEqual(termsyn5.text, 'deficient long term potentiation | deficient LTP | reduced long term potentiation')
        # Verify table row 6
    ...
    def test_rel_hp_add_man_match2(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0000045")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
    ...
    def test_rel_hp_over_man_match(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0000083")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
        # Iterate the table columns for rows 1
    ...
    def test_rel_hp_add_man_broad(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0410030")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
    ...
    def test_rel_hp_over_lex_exact(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0030160")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
        # Iterate the table columns for row 1
        ...
        self.assertEqual(termsyn1.text, 'canalis cervicis uteri inflammation | caudal segment of uterus inflammation | cervical canal inflammation | cervical canal of uterus inflammation | cervical inflammation | cervicitis | cervix inflammation | cervix uteri inflammation | neck of uterus inflammation')
    ...
    def test_rel_hp_add_lex_match2(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0011040")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
        ...
        self.assertEqual(termsyn2.text, 'abnormal cannalicular ductule morphology | abnormal ductuli biliferi | abnormal intrahepatic bile duct morphology')
    ...
    def test_rel_hp_add_man_match3(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0005262")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
        # Iterate the table columns for rows 1 & 2
        ...
        self.assertEqual(termsyn2.text, 'abnormal stratum synoviale morphology | abnormal synovial joint lining morphology | abnormal synovial layer of articular capsule morphology | abnormal synovial membrane morphology | abnormal synovial membrane of synovial joint morphology | abnormal synovium morphology')
    ...
    def test_rel_hp_over_lex_exact(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0000062")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
        # Iterate the table columns for rows 1
    ...
    def test_rel_add_man_match_over_lex_exact(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0100333")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
        ...
        self.assertEqual(termsyn2.text, 'one sided cleft upper lip | one-sided cleft upper lip | unilateral cheiloschisis | unilateral cleft lip')
    ...
    def test_rel_add_man_match4(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[-1])
        wait.forNewWindow(self.driver, 2)
        self.driver.find_element(By.ID, "hpmpInput").send_keys("HP:0100336")  #identifies the input field and enters an MP ID
        self.driver.find_element(By.XPATH, '/html/body/form/div[4]/input[1]').click() #find the Search  for related terms button and click it
        mphp_table = self.driver.find_element(By.ID, 'hmdcTermSearchTable')
        table = Table(mphp_table)
        # Iterate the table columns for row 1 & 2
