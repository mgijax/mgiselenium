...
class TestHmdcSearchTerm(unittest.TestCase):
    ...
    def test_do_term_name(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "mucosulfatidosis")  # identifies the input field and enters term/ID
        self.driver.find_element(By.ID, "searchButton").click()
        ...
        print(grid_tab.text)
        time.sleep(2)
        self.assertIn(grid_tab.text, "Gene Homologs x Phenotypes/Diseases (1 x 20)",
                      "Data has changed for this test - update may be needed")
        grid_tab.click()
    ...
    def test_mp_term_name(self):
        ...
        my_select = self.driver.find_element(By.XPATH,
                                             "//select[starts-with(@id, 'field_0_')]")  # identifies the select field and picks the phenotype name option
        for option in my_select.find_elements(By.TAG_NAME, "option"):
            if option.text == 'Disease or Phenotype Name':
                option.click()
                break
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "meteorism")  # identifies the input field and enters term
        wait.forAngular(self.driver)

        self.driver.find_element(By.XPATH, "//*[contains(text(), 'Add')]").click()
        my_select1 = self.driver.find_element(By.XPATH,
                                              "//select[starts-with(@id, 'field_0_4')]")  # identifies the select field and picks the phenotype name option
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Celsr3")  # identifies the input field and enters Celsr3
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_hp_term_name(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "fusion of middle ear ossicles")  # identifies the input field and enters gata1
        wait.forAngular(self.driver)
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "TFAP2A")  # identifies the input field and enters TFAP2A
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
        ...
        headingcells = self.driver.find_elements(By.CSS_SELECTOR,
                                                 "div.ngc.cell-content.ngc-custom-html.ng-binding.ng-scope")
        ...
        phenocell = self.driver.find_element(By.CSS_SELECTOR,
                                             "td.middle:nth-child(9) > div:nth-child(1) > div:nth-child(1)")
        ...
        # asserts the heading text is correct in page source
        self.assertEqual(matching_text.text, 'Human hearing/vestibular/ear abnormalities for TFAP2A/Tfap2a',
                         'expected pop-up box heading not displayed')
    ...
    def test_do_term_syn_name(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "rickets, vitamin D-resistant")  # synonym for DOID:0050445; X-linked hypophosphatemic
        # wait.forAngular(self.driver)
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
        # identify the grid tab and click on it
    ...
    def test_mp_term_syn_name(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "albino coat")  # identifies the input field and enters the MP synonym
        wait.forAngular(self.driver)
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Mitf")  # identifies the input field and enters a specific gene symbol
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
        ...
        print(matching_text.text)
        # asserts the heading text is correct in page source
        self.assertEqual(matching_text.text, 'Mouse integument abnormalities for MITF/Mitf',
                         'expected heading not displayed')
    ...
    def test_hp_term_syn_name(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "Gower sign")  # this is a synonym for the HP term "Gowers sign"
        wait.forAngular(self.driver)
        self.driver.find_element(By.XPATH, "//*[contains(text(), 'Add')]").click()
        my_select1 = self.driver.find_element(By.XPATH,
                                              "//select[starts-with(@id, 'field_0_4')]")  # identifies the select field and picks the phenotype name option
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "ALG2")  # identifies the input field and enters a specific gene symbol
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_do_term_down_dag(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "ciliopathy")  # identifies the input field and enters term/ID
        wait.forAngular(self.driver)
        self.driver.find_element(By.XPATH, "//*[contains(text(), 'Add')]").click()
        my_select1 = self.driver.find_element(By.XPATH,
                                              "//select[starts-with(@id, 'field_0_4')]")  # identifies the select field and picks the phenotype name option
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Ahi1")  # identifies the input field and enters a specific gene symbol
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_mp_term_normal_models(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Pax9")  # identifies the input field and enters Pax9
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_mp_term_simple_Homozygous(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "tremors")  # identifies the input field and enters term
        wait.forAngular(self.driver)
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Aars1")  # identifies the input field and enters a specific gene symbol
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
        ...
        head = self.driver.find_element(By.ID,'title')
        print(head.text)
        # asserts the heading text is correct in page source
        self.assertEqual(matching_text, head.text, 'expected pop-up box heading not displayed')

        # asserts that the MP term queried for has been returned
        self.assertIn("Aars1<sup>sti</sup>/Aars1<sup>sti</sup>", self.driver.page_source,
                      "expected simple genotype not found")
    ...
    def test_mp_term_simple_Hemizygous(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "hippocampal neuron degeneration")  # identifies the input field and enters term
        wait.forAngular(self.driver)
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Tg(Camk2a-tTA)1Mmay")  # identifies the input field and enters a specific gene symbol
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_mp_term_simple_Indeterminate(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "increased incidence of corneal inflammation")  # identifies the input field and enters term
        wait.forAngular(self.driver)
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Eda")  # identifies the input field and enters a specific gene symbol
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_mp_term_Cond_Recomb(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "abnormal liver morphology")  # identifies the input field and enters term
        wait.forAngular(self.driver)
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Abcb7, Tg(Alb-cre)21Mgn")  # identifies the input field and enters a specific gene symbol
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_mp_term_Cond_Recomb_1(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "abnormal eye development")  # identifies the input field and enters term
        wait.forAngular(self.driver)
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Hesx1")  # identifies the input field and both genes of the complex genotype
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_mp_term_Cond_Recomb_2(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "increased lung adenoma incidence")  # identifies the input field and enters term
        wait.forAngular(self.driver)
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Kras")  # identifies the input field and both genes of the complex genotype
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
    ...
    def test_mp_term_Trans_Reporter(self):
        ...
        self.driver.find_element(By.NAME, "formly_3_autocomplete_input_0").send_keys(
            "abnormal cerebral cortex pyramidal cell morphology")  # identifies the input field and enters term
        wait.forAngular(self.driver)
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "Nrp1, Tg(Thy1-YFP)16Jrs")  # identifies the input field and both genes of the complex genotype
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
        ...
        self.assertNotIn("Tg(Thy1-YFP)16Jrs", searchtermitems,
                         "this transgenic reporter is being returned, it should not be!")
    ...
    def test_mp_term_Large_Complex_Geno(self):
        ...
        self.driver.find_element(By.ID, "formly_3_input_input_0").clear()
        self.driver.find_element(By.NAME, "formly_3_input_input_0").send_keys(
            "MP:0001829")  # identifies the input field and enters an ID
        self.driver.find_element(By.ID, "searchButton").click()
        wait.forAngular(self.driver)
