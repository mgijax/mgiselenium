...
class TestStrainDetail(unittest.TestCase):
    ...
    def test_strain_strain_fam_link(self):
        ...
        self.assertEqual(fam_mem.text, '97')  # assert the strain family member link is correct
    ...
    def test_strain_det_mut_multi_assoc(self):
        ...
        self.assertEqual(mut_cells,
                             ['Mutation Carried', 'Aanatrs216509331-A', 'Ahrb-1', 'Anxa6rs26961431-G', 'Apobec3Rfv3-r', 'B2mb', 'Cd5b',
                              'Cdh23ahl', 'Cox7a2ls', 'Fbrwt1C57BL/6J', 'Fbrwt2C57BL/6J', 'Gabra2C57BL/6J',
                              'Gluchos1C57BL/6J', 'Gluchos2C57BL/6J', 'Gluchos3C57BL/6J', 'Hbbs', 'Ltbp4dmod1-r', 'Micrln', 'Mx1s1',
        ...
        self.assertEqual(gene_cells,
                             ['Marker', 'Aanat', 'Ahr', 'Anxa6', 'Apobec3', 'B2m', 'Cd5', 'Cdh23', 'Cox7a2l', 'Fbrwt1', 'Fbrwt2',
                              'Gabra2', 'Gluchos1', 'Gluchos2', 'Gluchos3', 'Hbb', 'Ltbp4', 'Micrl', 'Mx1', 'n-TRtct5', 'Nlrp12',
                              'Nnt', 'P2rx7'])
    ...
    def test_strain_det_mut_assocnum(self):
        ...
        self.assertEqual(mut_count.text, '22 associated mutations', 'associated mutations count/text is wrong')
    ...
    def test_strain_humdis_disease_link(self):
        ...
        print(disname.text)
        self.assertEqual(disname.text, 'X-linked hypophosphatemic rickets (DOID:0050445)')
    ...
    def test_strain_ref_early_link(self):
        ...
        driver.switch_to.window(self.driver.window_handles[-1])
        # locates the earliest reference link and clicks it
        jnum = driver.find_element(By.LINK_TEXT, 'J:22753')
        driver.execute_script("arguments[0].click();", jnum)
        # verify the J number J:22753 exists on this page
