...
class TestCreSpecificity(unittest.TestCase):
    ...
    def test_Matrix_sort(self):
        ...
        self.driver.find_element(By.CSS_SELECTOR,
                                 '#yui-rec1 > td:nth-child(2) > div:nth-child(1) > a:nth-child(1)').click()
        self.driver.switch_to.window(self.driver.window_handles[-1])
        # find the gene expression column and grab the text
        geneexp = self.driver.find_element(By.CSS_SELECTOR,
                                           '#colGroupInner > g:nth-child(3) > g:nth-child(1) > text:nth-child(2)')
        print(geneexp.text)
        ...
        self.assertEqual('Tg(Nes-cre/ERT2)1Imayo', all8.text, 'seventh allele is not correct')
        self.assertEqual('Tg(Nes-cre/ERT2)4Imayo', all9.text, 'eighth allele is not correct')
        self.assertEqual('Tg(Nes-cre/ERT2)5-1Imayo', all10.text, 'ninth allele is not correct')
    ...
    def test_Matrix_species(self):
        ...
        self.driver.find_element(By.CSS_SELECTOR,
                                 '#yui-rec5 > td:nth-child(2) > div:nth-child(1) > a:nth-child(1) > img:nth-child(1)').click()
        self.driver.switch_to.window(self.driver.window_handles[-1])
        # capture and print on hover text for first allele
        tooltip = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col1:nth-child(1) > text:nth-child(2) > a:nth-child(1)")))
        hov = ActionChains(self.driver).move_to_element(tooltip)
        txt = hov.perform()
        tooltip = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col1:nth-child(1) > text:nth-child(2) > title:nth-child(2)"))).get_attribute(
            "innerHTML")
        print(tooltip)
        # capture and print on hover text for second allele
        tooltip2 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col2:nth-child(1) > text:nth-child(2) > a:nth-child(1)")))
        hov = ActionChains(self.driver).move_to_element(tooltip2)
        txt = hov.perform()
        tooltip2 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col2:nth-child(1) > text:nth-child(2) > title:nth-child(2)"))).get_attribute(
            "innerHTML")
        print(tooltip2)
        # capture and print on hover text for third allele
        tooltip3 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col3:nth-child(1) > text:nth-child(2) > a:nth-child(1)")))
        hov = ActionChains(self.driver).move_to_element(tooltip3)
        txt = hov.perform()
        tooltip3 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col3:nth-child(1) > text:nth-child(2) > title:nth-child(2)"))).get_attribute(
            "innerHTML")
        print(tooltip3)
        # capture and print on hover text for fourth allele
        tooltip4 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col4:nth-child(1) > text:nth-child(2) > a:nth-child(1)")))
        hov = ActionChains(self.driver).move_to_element(tooltip4)
        txt = hov.perform()
        tooltip4 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col4:nth-child(1) > text:nth-child(2) > title:nth-child(2)"))).get_attribute(
            "innerHTML")
        print(tooltip4)
        # capture and print on hover text for fifth allele
        tooltip5 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col5:nth-child(1) > text:nth-child(2) > a:nth-child(1)")))
        hov = ActionChains(self.driver).move_to_element(tooltip5)
        txt = hov.perform()
        tooltip5 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col5:nth-child(1) > text:nth-child(2) > title:nth-child(2)"))).get_attribute(
            "innerHTML")
        print(tooltip5)
        # capture and print on hover text for sixth allele
        tooltip6 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col6:nth-child(1) > text:nth-child(2) > a:nth-child(1)")))
        hov = ActionChains(self.driver).move_to_element(tooltip6)
        txt = hov.perform()
        tooltip6 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col6:nth-child(1) > text:nth-child(2) > title:nth-child(2)"))).get_attribute(
            "innerHTML")
        print(tooltip6)
        # capture and print on hover text for seventh allele
        tooltip7 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col7:nth-child(1) > text:nth-child(2) > a:nth-child(1)")))
        hov = ActionChains(self.driver).move_to_element(tooltip7)
        txt = hov.perform()
        tooltip7 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col7:nth-child(1) > text:nth-child(2) > title:nth-child(2)"))).get_attribute(
            "innerHTML")
        print(tooltip7)
        # capture and print on hover text for seventh allele
        tooltip8 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col8:nth-child(1) > text:nth-child(2) > a:nth-child(1)")))
        hov = ActionChains(self.driver).move_to_element(tooltip8)
        txt = hov.perform()
        tooltip8 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col8:nth-child(1) > text:nth-child(2) > title:nth-child(2)"))).get_attribute(
            "innerHTML")
        print(tooltip8)
        # capture and print on hover text for seventh allele
        tooltip9 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col9:nth-child(1) > text:nth-child(2) > a:nth-child(1)")))
        hov = ActionChains(self.driver).move_to_element(tooltip9)
        txt = hov.perform()
        tooltip9 = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "g.col9:nth-child(1) > text:nth-child(2) > title:nth-child(2)"))).get_attribute(
            "innerHTML")
        print(tooltip9)
