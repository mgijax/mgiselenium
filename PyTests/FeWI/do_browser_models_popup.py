...
class TestDoBrowserModelsPopup(unittest.TestCase):
    ...
    def test_dobrowser_modelspopup_onlynots(self):
        ...
        self.assertEqual(row1.text, 'Ror2tm1Anec/Ror2+ B6.129S1-Ror2tm1Anec J:134490 View',
                         'Wrong data displayed for row 1!')
        print(row1.text)
    ...
    def test_dobrowser_modelspopup_onlyhuman(self):
        ...
        self.assertEqual(row1.text,
                         'Psen1tm2Shn/Psen1tm4.1Shn\nPsen2tm1Haa/Psen2tm1Haa\nTg(Camk2a-cre)1Shn/0 involves: 129 * 129S4/SvJae * C57BL/6 * C57BL/6J * CBA J:219929 View',
                         'Wrong data displayed for row 1!')
        print(row1.text)
    ...
    def test_dobrowser_modelspopup_mouse_nots(self):
        ...
        row1 = table1.get_row(1)
        self.assertEqual(row1.text,
                         'Ighmtm1Cgn/Ighmtm1Cgn\nTg(Igh-VB1-8/Igh-6m)1Mjsk/? NODCaj.Cg-Ighmtm1Cgn Tg(Igh-VB1-8/Igh-6m)1Mjsk/FswJ J:93190 View',
                         'Wrong data displayed for row 2!')
        row2 = table1.get_row(2)
        self.assertEqual(row2.text, 'Tg(Igh-6/Igh-V281)3Jwt/0 NOD.B6-Tg(Igh-6/Igh-V281)3Jwt J:91865 View',
                         'Wrong data displayed for row 1!')
        row3 = table1.get_row(3)
        self.assertEqual(row3.text,
                         'Tg(Igh-6/Igh-V125)2Jwt/0\nTg(Igk-C/Igk-V125)1Jwt/0 NOD.B6-Tg(Igh-6/Igh-V125)2Jwt Tg(Igk-C/Igk-V125)1Jwt J:91865 View',
                         'Wrong data displayed for row 3!')
        row4 = table1.get_row(4)
        self.assertEqual(row4.text,
                         'Ighmtm1Cgn/Ighm+\nTg(Igh-6/Igh-V281)3Jwt/0 NOD.Cg-Ighmtm1Cgn Tg(Igh-6/Igh-V281)3Jwt J:91865 View',
                         'Wrong data displayed for row 4!')
        row5 = table1.get_row(5)
        self.assertEqual(row5.text, 'Ighmtm1Cgn/Ighm+ NOD.129S2-Ighmtm1Cgn J:37287 View',
                         'Wrong data displayed for row 5!')
        ...
        self.assertEqual(row1.text, 'Ighmtm1Cgn/Ighmtm1Cgn NOD.129S2-Ighmtm1Cgn J:37287 View',
                         'Wrong data displayed for row 1!')
        row2 = table2.get_row(2)
        # print(row2.text)
        self.assertEqual(row2.text, 'Ighmtm1Cgn/Ighmtm1Cgn NOD.129S2-Ighmtm1Cgn/DvsJ J:80859 View',
                         'Wrong data displayed for row 2!')
        row3 = table2.get_row(3)
        self.assertEqual(row3.text,
                         'Ighmtm1Cgn/Ighmtm1Cgn\nTg(IghelMD4)4Ccg/Tg(IghelMD4)4Ccg NOD.Cg-Ighmtm1Cgn Tg(IghelMD4)4Ccg/DvsJ J:80859 View',
                         'Wrong data displayed for row 3!')
