...
class TestDoBrowserGeneTab(unittest.TestCase):
    ...
    def test_dobrowser_header(self):
        ...
        print(alt_id.text)
        self.assertEqual(alt_id.text,
                         "OMIM:211980, OMIM:608935, OMIM:612571, OMIM:612593, OMIM:614210, DOID:13075, DOID:1322, DOID:9881, ICD10CM:C34.1, ICD10CM:C34.2, ICD10CM:C34.3, ICD9CM:162.3, ICD9CM:162.4, ICD9CM:162.5, ICD9CM:162.8, UMLS_CUI:C0024624, UMLS_CUI:C0153491, UMLS_CUI:C0153492, UMLS_CUI:C0153493")
    ...
    def test_dobrowser_genestab_m(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[1])
        # identifies the Genes tab and clicks it.
        self.driver.find_element(By.ID, 'genesTabButton').click()
        if WebDriverWait(self.driver, 5).until(EC.presence_of_element_located((By.CLASS_NAME, 'titleBarMainTitle'))):
            print('page loaded')
        gene_table = self.driver.find_element(By.ID, "geneTabTable")
        table = Table(gene_table)
