...
class TestTreeView(unittest.TestCase, EmapaBaseClass):
    ...
    def testSpecificStageTree(self):
        ...
        self.assertEqual(items[1].text, "Theiler Stage 20 (11.5-13 dpc)")
    ...
    def testDetailParent(self):
        ...
        items = term_det.find_elements_by_tag_name("dd")
        self.assertEqual(items[0].text, "cortical renal tubule")
        self.assertEqual(items[1].text, "Theiler Stage 24 (16-16.99 dpc)")
        ...
        items = term_det.find_elements_by_tag_name("dd")
        self.assertEqual(items[0].text, "cortical renal tubule")
        self.assertEqual(items[1].text, "Theiler Stage 22 (13.5-15 dpc)")
    ...
    def testParentStage(self):
        ...
        items = term_det.find_elements_by_tag_name("dd")
        self.assertEqual(items[0].text, "3rd ventricle")
        self.assertEqual(items[1].text, "Theiler Stage 15 (9-10.25 dpc)")
